...
# load data
mesh <- st_read("C:/Users/tinos/Documents/Master - Climate Science/3 - Master Thesis/master_thesis/data-raw/MedStat/MEDSTAT_AREAS_2019.shp", quiet = TRUE)
...
write.csv(list_regions, file = paste0("C:/Users/tinos/Documents/Master - Climate Science/3 - Master Thesis/master_thesis/data/MetStatRegions/MDSTID_MetRegions_", buffer_size, ".csv"))
```
...
map_plot <- ggplot() +
  ...
  geom_sf(data = mesh$geometry[mesh$MDST04 == "VS20"], fill = "red", alpha = 0.7) +
  geom_sf(data = mesh$geometry[mesh$MDST04 == "BE86" ], fill = "red", alpha = 0.7) +
  geom_sf(data = mesh$geometry[mesh$MDST04 == "GR22" ], fill = "red", alpha = 0.7) +
  geom_sf(data = mesh$geometry[mesh$MDST04 == "GR10" ], fill = "green2", alpha = 0.7) +
